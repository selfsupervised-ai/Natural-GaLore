...
\usepackage{natural_galore_template/natural_galore,times}

\input{natural_galore_template/math_commands.tex}
\input{natural_galore_template/packages}
\input{natural_galore_template/macros}
\usepackage{hyperref}
\usepackage{url}
\usepackage{forest}
\usepackage{tikz}
...
\input{sections/3_natural_galore.tex}
\input{sections/4_experiments.tex}
\input{sections/5_conclusion.tex}

\bibliography{natural_galore_template/natural_galore}
\bibliographystyle{natural_galore_template/natural_galore}
